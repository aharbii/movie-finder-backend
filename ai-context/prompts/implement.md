...
You are implementing GitHub issue #[ISSUE_NUMBER] in `aharbii/movie-finder-backend`.

Step 1: Fetch the issue.
gh issue view [ISSUE_NUMBER] --repo aharbii/movie-finder-backend
...
gh pr create --repo aharbii/movie-finder-backend --title "..." --body "..."
...
gh issue comment [N] --repo [REPO] --body "PR aharbii/movie-finder-backend#[PR]: [url]. [what this means for that issue]"
